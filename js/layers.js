addLayer("p", {
    name: "Chapter 1", // This is optional, only used in a few places, If absent it just uses the layer id.
    ...
    upgrades: {
        ...
        13: {
            title: "Powered-Up",
            description: "Exponentiate the previous upgrade's effect to ^1.1 (this will get WAY better later on)",
            cost: new Decimal(2),
        },
    },
})
